...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'LaserDefenderBeta.data';
    var REMOTE_PACKAGE_BASE = 'LaserDefenderBeta.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 9938650;
      var PACKAGE_UUID = '8752f01d-5011-4920-856e-c0508f2521b1';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 7073271, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(7073271, 7073606, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(7073606, 7080533, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(7080533, 9036053, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9036053, 9911025, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(9911025, 9938650, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_LaserDefenderBeta.data');

    };
    Module['addRunDependency']('datafile_LaserDefenderBeta.data');
